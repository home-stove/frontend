      ...
      <main className="py-5 lg:pt-24">
        ...
        <div className="px-4 md:px-10 pb-5">
          <p className="text-sm text-[#0c0c0c]">
            Home <span className="text-[#a2a2a2]">/ Jobs</span>
          </p>
        </div>
        {/* The Hero Section */}
        <div
        ...
        >
          ...
          <div className="xl:flex xl:flex-col xl:justify-center xl:h-full">
            <div className="pb-3">
              ...
              Find Baking Jobs in Your Area
              </h1>
            </div>
            <div className="pb-3 xl:pb-7">
              <p className="text-sm leading-6">
              From wedding cakes to artisan bread, explore exciting baking projects posted by local customers. Bid on jobs that match your skills and grow your business.
              </p>
            </div>
