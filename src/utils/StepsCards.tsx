...
const steps: { id: string; title: string; description: string; icon: string }[] = [
  {
    id: "step-1",
    title: "Join the Bakers Community",
    description: "Sign up quickly to access job opportunities and connect with fellow bakers.",
  ...
  },
  {
    ...
    description: "Create a portfolio that highlights your best baked creations to attract clients.",
  ...
  },
  {
    ...
    description: "Browse jobs, filter by expertise, and submit bids to secure work.",
  ...
  },
  {
    ...
    description: "Deliver on time and ensure customer satisfaction to build your reputation.",
  ...
  },
  {
    ...
    description: "Receive secure, timely payments through the app after completing jobs.",
...
function StepsCards({}: Props) {
  return (
    <>
    {steps.map((step) => (
      <div className="rounded-lg my-5 p-3 bg-white h-44 w-72 flex flex-col justify-around" style={{boxShadow: "0px 6px 15px 0px rgba(64.00000000000001, 79.00000000000006, 104.00000000000004, 0.09)"}} key={step.id}>
        <div className="w-10">
