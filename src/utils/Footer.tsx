  ...
  return (
    <footer className="relative font-montserrat bg-[#222222] text-white">
      <div className="px-4 py-8">
        <div className="border-b border-b-[#3f3f3f]">
          <div className="flex flex-wrap text-sm font-semibold mb-5 gap-y-2">
            <p>Terms of Service</p>
            <p className="ml-5">Privacy Policy</p>
            <p className="w-1/3">Site Map</p>
          </div>
        ...
        <div className="py-10 border-b border-b-[#3f3f3f]">
          <div className="mb-9">
            <ul className="leading-8">
              <li className="font-semibold">About</li>
              <li className="text-sm leading-8 text-[#a2a2a2]">About Us</li>
              <li className="text-sm leading-8 text-[#a2a2a2]">
                Become a Baker
              </li>
              <li className="text-sm leading-8 text-[#a2a2a2]">
                Jobs on Home Stove
          ...
          <div className="mb-9">
            <ul className="leading-8">
              ...
              <li className="text-sm leading-8 text-[#a2a2a2]">Pies & Tarts</li>
              <li className="text-sm leading-8 text-[#a2a2a2]">
                Gluten-Free Baking
              </li>
              <li className="text-sm leading-8 text-[#a2a2a2]">
          ...
          <div className="mb-9">
            <ul className="leading-8">
              ...
              <li className="text-sm leading-8 text-[#a2a2a2]">Help Center</li>
              <li className="text-sm leading-8 text-[#a2a2a2]">FAQ</li>
              <li className="text-sm leading-8 text-[#a2a2a2]">Contact Us</li>
            </ul>
          </div>
          <div>
            <div>
              <h6 className="font-semibold mb-5">Subscribe</h6>
              <div className="bg-[#3f3f3f] rounded-lg flex justify-evenly h-14 w-72 mb-8">
                <input
