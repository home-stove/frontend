import { CityFilterCombobox, SpecialityFilterCombobox } from "@/components/ui/combobox";
  ...
  return (
    <div className="flex flex-col gap-10">
        ...
        <div className="mb-6">
            ...
            <input type="text" className="bg-[#a2a2a2] bg-opacity-5 h-10 text-[#797979] placeholder:text-[#797979] placeholder:text-sm px-3 w-full rounded-lg" placeholder="e.g. Baking Bliss by Maria" />
        </div>
        {/* Speciality */}
        <div>
